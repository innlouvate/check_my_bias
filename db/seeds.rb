...
answers_one.each do |answer|
  Answer.create!(content: answer, question_id: 1)
end

answers_two.each do |answer|
  Answer.create!(content: answer, question_id: 2)
end

answers_three.each do |answer|
  Answer.create!(content: answer, question_id: 3)
end

answers_four.each do |answer|
  Answer.create!(content: answer, question_id: 4)
end
